                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <div className="space-y-4">
                                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                                    <h4 className="font-medium text-blue-900 dark:text-blue-100 mb-2">1. Автоматическое сканирование</h4>
                                    <p className="text-blue-800 dark:text-blue-200 text-sm">
                                        Если DataMatrix содержит верный штрихкод EAN-13, система автоматически загрузит данные о товаре из базы данных и напечатает этикетку с полной информацией.
                                    </p>
                                </div>
                                <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
                                    <h4 className="font-medium text-green-900 dark:text-green-100 mb-2">2. Ручной выбор товара</h4>
                                    <p className="text-green-800 dark:text-green-200 text-sm">
                                        Пользователь выбирает товар и размер из базы данных, затем сканирует любой DataMatrix код. Система напечатает отсканированный DataMatrix с корректными данными выбранного товара и его штрихкодом.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-400">
                                ...
                                <li>
                                    <strong>Для ручного режима:</strong> найдите товар по названию, выберите размер, введите DataMatrix код
                                </li>
                                <li>Получите распечатанные этикетки</li>
                            </ol>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                                <li>Автоматическое определение корректности DataMatrix штрихкодов</li>
                                <li>Возможность работы с некорректными DataMatrix кодами</li>
                                <li>Точное соответствие данных товара и размера</li>
                                <li>Универсальность для различных поставщиков</li>
                            </ul>
                        </div>
